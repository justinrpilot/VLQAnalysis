...
infile = "templates/theta4jet_0.8tz_0.0bw_0.2th.root" 
...
expected.write_txt("limitsJAN_0.8tz_0.0bw_0.2th.txt")
observed.write_txt("obslimitsJAN_0.8tz_0.0bw_0.2th.txt")
