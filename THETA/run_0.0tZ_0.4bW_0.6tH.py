...
infile = "templates/theta4jet_0.0tz_0.4bw_0.6th.root" 
...
expected.write_txt("limitsJAN_0.0tz_0.4bw_0.6th.txt")
observed.write_txt("obslimitsJAN_0.0tz_0.4bw_0.6th.txt")
