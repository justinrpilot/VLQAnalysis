...
infile = "templates/thetaBB4jet_0.2tz_0.2bw_0.6th.root" 
...
expected.write_txt("limitsBBJAN_0.2tz_0.2bw_0.6th.txt")
observed.write_txt("obslimitsBBJAN_0.2tz_0.2bw_0.6th.txt")
