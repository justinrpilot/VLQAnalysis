...
#       mod.add_lognormal_uncertainty('ttagT', math.log(1.10),p)
    ...
    mod.add_lognormal_uncertainty('toptagSF_full', 0.20, 'ttbarF')    
    mod.add_lognormal_uncertainty('toptagSF_part', 0.20, 'ttbarP')    


    return mod

infile = "sfW2_templates.root"
