...
infile = "templates/thetaBB4jet_0.6tz_0.4bw_0.0th.root" 
...
expected.write_txt("limitsBBJAN_0.6tz_0.4bw_0.0th.txt")
observed.write_txt("obslimitsBBJAN_0.6tz_0.4bw_0.0th.txt")
