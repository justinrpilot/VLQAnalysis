...
infile = "templates/theta4jet_0.0tz_0.8bw_0.2th.root" 
...
expected.write_txt("limitsJAN_0.0tz_0.8bw_0.2th.txt")
observed.write_txt("obslimitsJAN_0.0tz_0.8bw_0.2th.txt")
