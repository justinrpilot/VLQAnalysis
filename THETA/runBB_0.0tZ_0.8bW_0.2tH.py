...
infile = "templates/thetaBB4jet_0.0tz_0.8bw_0.2th.root" 
...
expected.write_txt("limitsBBJAN_0.0tz_0.8bw_0.2th.txt")
observed.write_txt("obslimitsBBJAN_0.0tz_0.8bw_0.2th.txt")
