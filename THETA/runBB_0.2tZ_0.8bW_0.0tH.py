...
infile = "templates/thetaBB4jet_0.2tz_0.8bw_0.0th.root" 
...
expected.write_txt("limitsBBJAN_0.2tz_0.8bw_0.0th.txt")
observed.write_txt("obslimitsBBJAN_0.2tz_0.8bw_0.0th.txt")
