...
infile = "templates/theta4jet_0.2tz_0.8bw_0.0th.root" 
...
expected.write_txt("limitsJAN_0.2tz_0.8bw_0.0th.txt")
observed.write_txt("obslimitsJAN_0.2tz_0.8bw_0.0th.txt")
