...
infile = "templates/thetaBB4jet_0.6tz_0.0bw_0.4th.root" 
...
expected.write_txt("limitsBBJAN_0.6tz_0.0bw_0.4th.txt")
observed.write_txt("obslimitsBBJAN_0.6tz_0.0bw_0.4th.txt")
