...
infile = "templates/thetaBB4jet_0.0tz_0.2bw_0.8th.root" 
...
expected.write_txt("limitsBBJAN_0.0tz_0.2bw_0.8th.txt")
observed.write_txt("obslimitsBBJAN_0.0tz_0.2bw_0.8th.txt")
