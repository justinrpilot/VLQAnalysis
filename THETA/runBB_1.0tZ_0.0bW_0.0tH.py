...
infile = "templates/thetaBB4jet_1.0tz_0.0bw_0.0th.root" 
...
expected.write_txt("limitsBBJAN_1.0tz_0.0bw_0.0th.txt")
observed.write_txt("obslimitsBBJAN_1.0tz_0.0bw_0.0th.txt")
