...
infile = "templates/theta4jet_0.2tz_0.0bw_0.8th.root" 
...
expected.write_txt("limitsJAN_0.2tz_0.0bw_0.8th.txt")
observed.write_txt("obslimitsJAN_0.2tz_0.0bw_0.8th.txt")
