...
infile = "templates/theta4jet_BRTZtz_BRBWbw_BRTHth.root" 
...
#expected.write_txt("limitsJAN_BRTZtz_BRBWbw_BRTHth.txt")
#observed.write_txt("obslimitsJAN_BRTZtz_BRBWbw_BRTHth.txt")
