...
infile = "templates/theta4jet_0.0tz_0.2bw_0.8th.root" 
...
expected.write_txt("limitsJAN_0.0tz_0.2bw_0.8th.txt")
observed.write_txt("obslimitsJAN_0.0tz_0.2bw_0.8th.txt")
