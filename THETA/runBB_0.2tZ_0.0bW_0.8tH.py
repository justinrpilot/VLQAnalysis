...
infile = "templates/thetaBB4jet_0.2tz_0.0bw_0.8th.root" 
...
expected.write_txt("limitsBBJAN_0.2tz_0.0bw_0.8th.txt")
observed.write_txt("obslimitsBBJAN_0.2tz_0.0bw_0.8th.txt")
