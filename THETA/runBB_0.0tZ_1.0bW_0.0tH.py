...
infile = "templates/thetaBB4jet_0.0tz_1.0bw_0.0th.root" 
...
expected.write_txt("limitsBBJAN_0.0tz_1.0bw_0.0th.txt")
observed.write_txt("obslimitsBBJAN_0.0tz_1.0bw_0.0th.txt")
