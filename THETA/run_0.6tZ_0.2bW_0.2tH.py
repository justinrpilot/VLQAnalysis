...
infile = "templates/theta4jet_0.6tz_0.2bw_0.2th.root" 
...
expected.write_txt("limitsJAN_0.6tz_0.2bw_0.2th.txt")
observed.write_txt("obslimitsJAN_0.6tz_0.2bw_0.2th.txt")
