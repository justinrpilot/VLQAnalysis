...
infile = "templates/theta4jet_0.6tz_0.4bw_0.0th.root" 
...
expected.write_txt("limitsJAN_0.6tz_0.4bw_0.0th.txt")
observed.write_txt("obslimitsJAN_0.6tz_0.4bw_0.0th.txt")
