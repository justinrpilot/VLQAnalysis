...
infile = "templates/thetaBB4jet_0.8tz_0.2bw_0.0th.root" 
...
expected.write_txt("limitsBBJAN_0.8tz_0.2bw_0.0th.txt")
observed.write_txt("obslimitsBBJAN_0.8tz_0.2bw_0.0th.txt")
