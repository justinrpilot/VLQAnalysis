...
infile = "templates/theta4jet_0.0tz_0.0bw_1.0th.root" 
...
expected.write_txt("limitsJAN_0.0tz_0.0bw_1.0th.txt")
observed.write_txt("obslimitsJAN_0.0tz_0.0bw_1.0th.txt")
