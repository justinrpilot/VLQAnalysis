...
infile = "templates/thetaBB4jet_0.2tz_0.6bw_0.2th.root" 
...
expected.write_txt("limitsBBJAN_0.2tz_0.6bw_0.2th.txt")
observed.write_txt("obslimitsBBJAN_0.2tz_0.6bw_0.2th.txt")
