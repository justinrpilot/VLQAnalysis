...
infile = "templates/thetaBB4jet_0.8tz_0.0bw_0.2th.root" 
...
expected.write_txt("limitsBBJAN_0.8tz_0.0bw_0.2th.txt")
observed.write_txt("obslimitsBBJAN_0.8tz_0.0bw_0.2th.txt")
