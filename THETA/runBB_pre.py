...
infile = "templates/thetaBB4jet_BRTZtz_BRBWbw_BRTHth.root" 
...
#expected, observed = bayesian_limits(model, 'all', n_toy = 1000, run_theta = True)
#expected.write_txt("limitsBBJAN_BRTZtz_BRBWbw_BRTHth.txt")
#observed.write_txt("obslimitsBBJAN_BRTZtz_BRBWbw_BRTHth.txt")
