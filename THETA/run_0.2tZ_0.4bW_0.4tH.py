...
infile = "templates/theta4jet_0.2tz_0.4bw_0.4th.root" 
...
expected.write_txt("limitsJAN_0.2tz_0.4bw_0.4th.txt")
observed.write_txt("obslimitsJAN_0.2tz_0.4bw_0.4th.txt")
