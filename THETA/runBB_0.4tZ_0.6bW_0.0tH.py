...
infile = "templates/thetaBB4jet_0.4tz_0.6bw_0.0th.root" 
...
expected.write_txt("limitsBBJAN_0.4tz_0.6bw_0.0th.txt")
observed.write_txt("obslimitsBBJAN_0.4tz_0.6bw_0.0th.txt")
