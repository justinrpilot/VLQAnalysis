...
infile = "templates/theta4jet_0.2tz_0.6bw_0.2th.root" 
...
expected.write_txt("limitsJAN_0.2tz_0.6bw_0.2th.txt")
observed.write_txt("obslimitsJAN_0.2tz_0.6bw_0.2th.txt")
