...
infile = "templates/thetaBB4jet_0.0tz_0.0bw_1.0th.root" 
...
expected.write_txt("limitsBBJAN_0.0tz_0.0bw_1.0th.txt")
observed.write_txt("obslimitsBBJAN_0.0tz_0.0bw_1.0th.txt")
