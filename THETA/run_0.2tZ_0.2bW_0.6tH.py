...
infile = "templates/theta4jet_0.2tz_0.2bw_0.6th.root" 
...
expected.write_txt("limitsJAN_0.2tz_0.2bw_0.6th.txt")
observed.write_txt("obslimitsJAN_0.2tz_0.2bw_0.6th.txt")
