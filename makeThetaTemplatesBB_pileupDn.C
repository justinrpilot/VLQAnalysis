...
void makeThetaTemplatesBB_pileupDn(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333){
...
string var = "ht";
TString selT = Form("(pileupWtDn/pileupWt)*(numJets == 4 && jetPt_j3 > 400. && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", numTop, numW, numZ, numH, numB);
...
cout << "HERE " << endl;
TFile *outFile = new TFile(TString::Format("%s_histos_pileupDn.root", channel.c_str()), "RECREATE");
...
histTT->Write(TString::Format("%s__ttbar__pileup__minus", channel.c_str()));
//histWj->Write(TString::Format("%s__wjets__pileup__minus", channel.c_str()));
//histZj->Write(TString::Format("%s__zjets__pileup__minus", channel.c_str()));
//histWW->Write(TString::Format("%s__diboson__pileup__minus", channel.c_str()));
//histTTW->Write(TString::Format("%s__ttV__pileup__minus", channel.c_str()));

hist_sig700->Write(TString::Format("%s__tprime700__pileup__minus", channel.c_str()));
hist_sig800->Write(TString::Format("%s__tprime800__pileup__minus", channel.c_str()));
hist_sig900->Write(TString::Format("%s__tprime900__pileup__minus", channel.c_str()));
hist_sig1000->Write(TString::Format("%s__tprime1000__pileup__minus", channel.c_str()));
hist_sig1100->Write(TString::Format("%s__tprime1100__pileup__minus", channel.c_str()));
hist_sig1200->Write(TString::Format("%s__tprime1200__pileup__minus", channel.c_str()));
hist_sig1300->Write(TString::Format("%s__tprime1300__pileup__minus", channel.c_str()));
hist_sig1400->Write(TString::Format("%s__tprime1400__pileup__minus", channel.c_str()));
hist_sig1500->Write(TString::Format("%s__tprime1500__pileup__minus", channel.c_str()));
hist_sig1600->Write(TString::Format("%s__tprime1600__pileup__minus", channel.c_str()));
hist_sig1700->Write(TString::Format("%s__tprime1700__pileup__minus", channel.c_str()));
hist_sig1800->Write(TString::Format("%s__tprime1800__pileup__minus", channel.c_str()));
