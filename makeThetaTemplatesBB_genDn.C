...
#include "TGraph.h"
//tZ = 1, bW = 2, tH = 3
void makeThetaTemplatesBB_genDn(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333, string extraWeight = "1", string label = "blah"){
...
cout << "HERE " << endl;
TFile *outFile = new TFile(TString::Format("%s_histos_%sDn.root", channel.c_str(), label.c_str()), "RECREATE");

histTT->Write(TString::Format("%s__ttbar__%s__minus", channel.c_str(), label.c_str()));
histWj->Write(TString::Format("%s__wjets__%s__minus", channel.c_str(), label.c_str()));
histZj->Write(TString::Format("%s__zjets__%s__minus", channel.c_str(), label.c_str()));
histWW->Write(TString::Format("%s__diboson__%s__minus", channel.c_str(), label.c_str()));
histTTW->Write(TString::Format("%s__ttV__%s__minus", channel.c_str(), label.c_str()));
histHbb->Write(TString::Format("%s__higgs__%s__minus", channel.c_str(), label.c_str()));

hist_sig700->Write(TString::Format("%s__tprime700__%s__minus", channel.c_str(), label.c_str()));
hist_sig800->Write(TString::Format("%s__tprime800__%s__minus", channel.c_str(), label.c_str()));
hist_sig900->Write(TString::Format("%s__tprime900__%s__minus", channel.c_str(), label.c_str()));
hist_sig1000->Write(TString::Format("%s__tprime1000__%s__minus", channel.c_str(), label.c_str()));
hist_sig1100->Write(TString::Format("%s__tprime1100__%s__minus", channel.c_str(), label.c_str()));
hist_sig1200->Write(TString::Format("%s__tprime1200__%s__minus", channel.c_str(), label.c_str()));
hist_sig1300->Write(TString::Format("%s__tprime1300__%s__minus", channel.c_str(), label.c_str()));
hist_sig1400->Write(TString::Format("%s__tprime1400__%s__minus", channel.c_str(), label.c_str()));
hist_sig1500->Write(TString::Format("%s__tprime1500__%s__minus", channel.c_str(), label.c_str()));
hist_sig1600->Write(TString::Format("%s__tprime1600__%s__minus", channel.c_str(), label.c_str()));
hist_sig1700->Write(TString::Format("%s__tprime1700__%s__minus", channel.c_str(), label.c_str()));
hist_sig1800->Write(TString::Format("%s__tprime1800__%s__minus", channel.c_str(), label.c_str()));
