...
#include "TGraph.h"
//tZ = 1, bW = 2, tH = 3
void makeThetaTemplates_genUp_3j(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333, string extraWeight = "1", string label = "blah"){
...
string var = "ht";
TString selT = Form("(%s) * (numJets == 3 && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", extraWeight.c_str(), numTop, numW, numZ, numH, numB);
...
//selT = Form("(numJets == 3 && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", numTop, numW, numZ, numH, numB);
//TString selT = Form("numJets == 3");
//sel = selT.Data();
...
TString sigselT = Form("(%s) * (((decayMode1 == 1 && decayMode2 == 1) || (decayMode2 == 1 && decayMode1 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 2) || (decayMode1 == 2 && decayMode2 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 1))*%f + ((decayMode1 == 2 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 2))*%f +((decayMode1 == 2 && decayMode2 == 2) || (decayMode2 == 2 && decayMode1 == 2))*%f + ((decayMode1 == 3 && decayMode2 == 3) || (decayMode2 == 3 && decayMode1 == 3))*%f  ) * (numJets == 3 && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", extraWeight.c_str(), 3*br_tz*3*br_tz, 3*br_tz*3*br_bw, 3*br_tz*3*br_th, 3*br_bw*3*br_th, 3*br_bw*3*br_bw, 3*br_th*3*br_th, numTop, numW, numZ, numH, numB);
