...
void makeThetaTemplates_jerDn_3j(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333){
...
TFile *fileTT = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_ttbar_jerDn.root", "READ");
TFile *fileWj = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_wjets_jerDn.root", "READ");
TFile *fileZj = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_zjets_jerDn.root", "READ");

TFile *fileWW = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_WW_jerDn.root", "READ");
TFile *fileWZ = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_WZ_jerDn.root", "READ");
TFile *fileZZ = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_ZZ_jerDn.root", "READ");

TFile *fileTTW = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_ttW_jerDn.root", "READ");
TFile *fileTTZ = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_ttZ_jerDn.root", "READ");
TFile *fileTTTT = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_tttt_jerDn.root", "READ");
...
TFile *sig700 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq700_jerDn.root", "READ");
TFile *sig800 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq800_jerDn.root", "READ");
TFile *sig900 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq900_jerDn.root", "READ");
TFile *sig1000 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1000_jerDn.root", "READ");
TFile *sig1100 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1100_jerDn.root", "READ");
TFile *sig1200 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1200_jerDn.root", "READ");
TFile *sig1300 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1300_jerDn.root", "READ");
TFile *sig1400 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1400_jerDn.root", "READ");
TFile *sig1500 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1500_jerDn.root", "READ");
TFile *sig1600 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1600_jerDn.root", "READ");
TFile *sig1700 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1700_jerDn.root", "READ");
TFile *sig1800 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1800_jerDn.root", "READ");
...
string var = "ht";
TString selT = Form("numJets == 3 && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d", numTop, numW, numZ, numH, numB);
...
TString sigselT = Form("(((decayMode1 == 1 && decayMode2 == 1) || (decayMode2 == 1 && decayMode1 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 2) || (decayMode1 == 2 && decayMode2 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 1))*%f + ((decayMode1 == 2 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 2))*%f +((decayMode1 == 2 && decayMode2 == 2) || (decayMode2 == 2 && decayMode1 == 2))*%f + ((decayMode1 == 3 && decayMode2 == 3) || (decayMode2 == 3 && decayMode1 == 3))*%f  ) * (numJets == 3 && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", 3*br_tz*3*br_tz, 3*br_tz*3*br_bw, 3*br_tz*3*br_th, 3*br_bw*3*br_th, 3*br_bw*3*br_bw, 3*br_th*3*br_th, numTop, numW, numZ, numH, numB);
...
cout << "HERE " << endl;
TFile *outFile = new TFile(TString::Format("%s_histos_jerDn.root", channel.c_str()), "RECREATE");
...
histTT->Write(TString::Format("%s__ttbar__jer__minus", channel.c_str()));
histWj->Write(TString::Format("%s__wjets__jer__minus", channel.c_str()));
histZj->Write(TString::Format("%s__zjets__jer__minus", channel.c_str()));
histWW->Write(TString::Format("%s__diboson__jer__minus", channel.c_str()));
histTTW->Write(TString::Format("%s__ttV__jer__minus", channel.c_str()));

hist_sig700->Write(TString::Format("%s__tprime700__jer__minus", channel.c_str()));
hist_sig800->Write(TString::Format("%s__tprime800__jer__minus", channel.c_str()));
hist_sig900->Write(TString::Format("%s__tprime900__jer__minus", channel.c_str()));
hist_sig1000->Write(TString::Format("%s__tprime1000__jer__minus", channel.c_str()));
hist_sig1100->Write(TString::Format("%s__tprime1100__jer__minus", channel.c_str()));
hist_sig1200->Write(TString::Format("%s__tprime1200__jer__minus", channel.c_str()));
hist_sig1300->Write(TString::Format("%s__tprime1300__jer__minus", channel.c_str()));
hist_sig1400->Write(TString::Format("%s__tprime1400__jer__minus", channel.c_str()));
hist_sig1500->Write(TString::Format("%s__tprime1500__jer__minus", channel.c_str()));
hist_sig1600->Write(TString::Format("%s__tprime1600__jer__minus", channel.c_str()));
hist_sig1700->Write(TString::Format("%s__tprime1700__jer__minus", channel.c_str()));
hist_sig1800->Write(TString::Format("%s__tprime1800__jer__minus", channel.c_str()));
