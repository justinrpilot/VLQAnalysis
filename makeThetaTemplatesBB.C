...
#include "TGraph.h"
//tZ = 1, bW = 2, tH = 3
void makeThetaTemplatesBB(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333){
...
cout << "HERE " << endl;
TFile *outFile = new TFile(TString::Format("%s_histos.root", channel.c_str()), "RECREATE");
...
hist_sig700->Write(TString::Format("%s__tprime700", channel.c_str()));
hist_sig800->Write(TString::Format("%s__tprime800", channel.c_str()));
hist_sig900->Write(TString::Format("%s__tprime900", channel.c_str()));
hist_sig1000->Write(TString::Format("%s__tprime1000", channel.c_str()));
hist_sig1100->Write(TString::Format("%s__tprime1100", channel.c_str()));
hist_sig1200->Write(TString::Format("%s__tprime1200", channel.c_str()));
hist_sig1300->Write(TString::Format("%s__tprime1300", channel.c_str()));
hist_sig1400->Write(TString::Format("%s__tprime1400", channel.c_str()));
hist_sig1500->Write(TString::Format("%s__tprime1500", channel.c_str()));
hist_sig1600->Write(TString::Format("%s__tprime1600", channel.c_str()));
hist_sig1700->Write(TString::Format("%s__tprime1700", channel.c_str()));
