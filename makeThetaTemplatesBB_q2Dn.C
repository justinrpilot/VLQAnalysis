...
void makeThetaTemplatesBB_q2Dn(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333){
...
string var = "ht";
TString selT = Form("q2WtDn*(numJets == 4 && jetPt_j3 > 400. && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", numTop, numW, numZ, numH, numB);
...
TString sigselT = Form("q2WtDn*(((decayMode1 == 1 && decayMode2 == 1) || (decayMode2 == 1 && decayMode1 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 2) || (decayMode1 == 2 && decayMode2 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 1))*%f + ((decayMode1 == 2 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 2))*%f +((decayMode1 == 2 && decayMode2 == 2) || (decayMode2 == 2 && decayMode1 == 2))*%f + ((decayMode1 == 3 && decayMode2 == 3) || (decayMode2 == 3 && decayMode1 == 3))*%f  ) * (numJets == 4 && jetPt_j3 > 400. && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", 3*br_tz*3*br_tz, 3*br_tz*3*br_bw, 3*br_tz*3*br_th, 3*br_bw*3*br_th, 3*br_bw*3*br_bw, 3*br_th*3*br_th, numTop, numW, numZ, numH, numB);
...
cout << "HERE " << endl;
TFile *outFile = new TFile(TString::Format("%s_histos_q2Dn.root", channel.c_str()), "RECREATE");
...
histTT->Write(TString::Format("%s__ttbar__q2__minus", channel.c_str()));
//histWj->Write(TString::Format("%s__wjets__q2__minus", channel.c_str()));
//histZj->Write(TString::Format("%s__zjets__q2__minus", channel.c_str()));
//histWW->Write(TString::Format("%s__diboson__q2__minus", channel.c_str()));
//histTTW->Write(TString::Format("%s__ttV__q2__minus", channel.c_str()));

hist_sig700->Scale( 1.303 );
hist_sig800->Scale( 1.303 );
hist_sig900->Scale( 1.303 );
hist_sig1000->Scale( 1.304 );
hist_sig1100->Scale( 1.305 );
hist_sig1200->Scale( 1.307 );
hist_sig1300->Scale( 1.309 );
hist_sig1400->Scale( 1.311 );
hist_sig1500->Scale( 1.313 );
hist_sig1600->Scale( 1.315 );
hist_sig1700->Scale( 1.317 );
hist_sig1800->Scale( 1.319 );
hist_sig700->Write(TString::Format("%s__tprime700__q2__minus", channel.c_str()));
hist_sig800->Write(TString::Format("%s__tprime800__q2__minus", channel.c_str()));
hist_sig900->Write(TString::Format("%s__tprime900__q2__minus", channel.c_str()));
hist_sig1000->Write(TString::Format("%s__tprime1000__q2__minus", channel.c_str()));
hist_sig1100->Write(TString::Format("%s__tprime1100__q2__minus", channel.c_str()));
hist_sig1200->Write(TString::Format("%s__tprime1200__q2__minus", channel.c_str()));
hist_sig1300->Write(TString::Format("%s__tprime1300__q2__minus", channel.c_str()));
hist_sig1400->Write(TString::Format("%s__tprime1400__q2__minus", channel.c_str()));
hist_sig1500->Write(TString::Format("%s__tprime1500__q2__minus", channel.c_str()));
hist_sig1600->Write(TString::Format("%s__tprime1600__q2__minus", channel.c_str()));
hist_sig1700->Write(TString::Format("%s__tprime1700__q2__minus", channel.c_str()));
hist_sig1800->Write(TString::Format("%s__tprime1800__q2__minus", channel.c_str()));
