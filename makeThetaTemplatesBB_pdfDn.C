...
void makeThetaTemplatesBB_pdfDn(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333){
...
string var = "ht";
TString selT = Form("pdfWtDn*(numJets == 4 && jetPt_j3 > 400. && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", numTop, numW, numZ, numH, numB);
...
TString sigselT = Form("pdfWtDn*(((decayMode1 == 1 && decayMode2 == 1) || (decayMode2 == 1 && decayMode1 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 2) || (decayMode1 == 2 && decayMode2 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 1))*%f + ((decayMode1 == 2 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 2))*%f +((decayMode1 == 2 && decayMode2 == 2) || (decayMode2 == 2 && decayMode1 == 2))*%f + ((decayMode1 == 3 && decayMode2 == 3) || (decayMode2 == 3 && decayMode1 == 3))*%f  ) * (numJets == 4 && jetPt_j3 > 400. && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", 3*br_tz*3*br_tz, 3*br_tz*3*br_bw, 3*br_tz*3*br_th, 3*br_bw*3*br_th, 3*br_bw*3*br_bw, 3*br_th*3*br_th, numTop, numW, numZ, numH, numB);
...
cout << "HERE " << endl;
TFile *outFile = new TFile(TString::Format("%s_histos_pdfDn.root", channel.c_str()), "RECREATE");
...
//histQCD_sampled_up->Write(TString::Format("%s__qcd__mistag__minus", channel.c_str()));
//histQCD_sampled_dn->Write(TString::Format("%s__qcd__mistag__minus", channel.c_str()));
histTT->Write(TString::Format("%s__ttbar__pdf__minus", channel.c_str()));
//histWj->Write(TString::Format("%s__wjets__pdf__minus", channel.c_str()));
//histZj->Write(TString::Format("%s__zjets__pdf__minus", channel.c_str()));
//histWW->Write(TString::Format("%s__diboson__pdf__minus", channel.c_str()));
//histTTW->Write(TString::Format("%s__ttV__pdf__minus", channel.c_str()));

hist_sig700->Scale( 1.106 );
hist_sig800->Scale( 1.106 );
hist_sig900->Scale( 1.104 );
hist_sig1000->Scale( 1.099 );
hist_sig1100->Scale( 1.099 );
hist_sig1200->Scale( 1.093 );
hist_sig1300->Scale( 1.098 );
hist_sig1400->Scale( 1.102 );
hist_sig1500->Scale( 1.099 );
hist_sig1600->Scale( 1.122 );
hist_sig1700->Scale( 1.121 );
hist_sig1800->Scale( 1.133 );



hist_sig700->Write(TString::Format("%s__tprime700__pdf__minus", channel.c_str()));
hist_sig800->Write(TString::Format("%s__tprime800__pdf__minus", channel.c_str()));
hist_sig900->Write(TString::Format("%s__tprime900__pdf__minus", channel.c_str()));
hist_sig1000->Write(TString::Format("%s__tprime1000__pdf__minus", channel.c_str()));
hist_sig1100->Write(TString::Format("%s__tprime1100__pdf__minus", channel.c_str()));
hist_sig1200->Write(TString::Format("%s__tprime1200__pdf__minus", channel.c_str()));
hist_sig1300->Write(TString::Format("%s__tprime1300__pdf__minus", channel.c_str()));
hist_sig1400->Write(TString::Format("%s__tprime1400__pdf__minus", channel.c_str()));
hist_sig1500->Write(TString::Format("%s__tprime1500__pdf__minus", channel.c_str()));
hist_sig1600->Write(TString::Format("%s__tprime1600__pdf__minus", channel.c_str()));
hist_sig1700->Write(TString::Format("%s__tprime1700__pdf__minus", channel.c_str()));
hist_sig1800->Write(TString::Format("%s__tprime1800__pdf__minus", channel.c_str()));
