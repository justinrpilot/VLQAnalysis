...
void makeThetaTemplatesBB_csvDn(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333){
...
cout << "HERE " << endl;
TFile *outFile = new TFile(TString::Format("%s_histos_csvDn.root", channel.c_str()), "RECREATE");
...
histTT->Write(TString::Format("%s__ttbar__csv__minus", channel.c_str()));
histWj->Write(TString::Format("%s__wjets__csv__minus", channel.c_str()));
histZj->Write(TString::Format("%s__zjets__csv__minus", channel.c_str()));
histWW->Write(TString::Format("%s__diboson__csv__minus", channel.c_str()));
histTTW->Write(TString::Format("%s__ttV__csv__minus", channel.c_str()));
histHbb->Write(TString::Format("%s__higgs__csv__minus", channel.c_str()));

hist_sig700->Write(TString::Format("%s__tprime700__csv__minus", channel.c_str()));
hist_sig800->Write(TString::Format("%s__tprime800__csv__minus", channel.c_str()));
hist_sig900->Write(TString::Format("%s__tprime900__csv__minus", channel.c_str()));
hist_sig1000->Write(TString::Format("%s__tprime1000__csv__minus", channel.c_str()));
hist_sig1100->Write(TString::Format("%s__tprime1100__csv__minus", channel.c_str()));
hist_sig1200->Write(TString::Format("%s__tprime1200__csv__minus", channel.c_str()));
hist_sig1300->Write(TString::Format("%s__tprime1300__csv__minus", channel.c_str()));
hist_sig1400->Write(TString::Format("%s__tprime1400__csv__minus", channel.c_str()));
hist_sig1500->Write(TString::Format("%s__tprime1500__csv__minus", channel.c_str()));
hist_sig1600->Write(TString::Format("%s__tprime1600__csv__minus", channel.c_str()));
hist_sig1700->Write(TString::Format("%s__tprime1700__csv__minus", channel.c_str()));
hist_sig1800->Write(TString::Format("%s__tprime1800__csv__minus", channel.c_str()));
