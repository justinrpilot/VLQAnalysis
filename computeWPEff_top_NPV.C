...
string cut = "best_class == 4 && jetPt > 1000 && jetPt < 1400";


TH1F *sigNumH = new TH1F("sigNumH", "sigNumH", 20, 0,100);
TH1F *bkgNumH = new TH1F("bkgNumH", "bkgNumH", 20, 0,100);
TH1F *sigDenH = new TH1F("sigDenH", "sigDenH", 20, 0,100);
TH1F *bkgDenH = new TH1F("bkgDenH", "bkgDenH", 20, 0,100);
sigNumH->Sumw2();
sigDenH->Sumw2();
bkgNumH->Sumw2();
bkgDenH->Sumw2();
...
sigTree->Draw("npv>>sigDenH") ;
bkgTree->Draw("npv>>bkgDenH");
sigTree->Draw("npv>>sigNumH", cut.c_str());
bkgTree->Draw("npv>>bkgNumH", cut.c_str());
