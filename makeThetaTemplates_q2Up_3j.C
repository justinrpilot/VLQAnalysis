...
void makeThetaTemplates_q2Up_3j(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333){
...
string var = "ht";
TString selT = Form("q2WtUp*(numJets == 3 && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", numTop, numW, numZ, numH, numB);
