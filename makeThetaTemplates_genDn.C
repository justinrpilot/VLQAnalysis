...
#include "TGraph.h"
//tZ = 1, bW = 2, tH = 3
void makeThetaTemplates_genDn(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333, string extraWeight = "1", string label = "blah"){
