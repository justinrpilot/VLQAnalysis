...
TFile *inFile_j0 = new TFile(Form("%s_rate_j0_rates.root", label.c_str()));
TFile *inFile_j1 = new TFile(Form("%s_rate_j1_rates.root", label.c_str()));
TFile *inFile_j2 = new TFile(Form("%s_rate_j2_rates.root", label.c_str()));
TFile *inFile_j3 = new TFile(Form("%s_rate_j3_rates.root", label.c_str()));
...
TFile *outFile = new TFile(Form("%s_combinedRates.root", label.c_str()), "RECREATE");
