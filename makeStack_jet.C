...
TFile *fileQCD_1 = TFile::Open("~/3DayLifetime/outplots_qcd1.root", "READ");
TFile *fileQCD_2 = TFile::Open("~/3DayLifetime/outplots_qcd2.root", "READ");
TFile *fileQCD_3 = TFile::Open("~/3DayLifetime/outplots_qcd3.root", "READ");
TFile *fileQCD_4 = TFile::Open("~/3DayLifetime/outplots_qcd4.root", "READ");
TFile *fileQCD_5 = TFile::Open("~/3DayLifetime/outplots_qcd5.root", "READ");
TFile *fileQCD_6 = TFile::Open("~/3DayLifetime/outplots_qcd6.root", "READ");
TFile *fileQCD_7 = TFile::Open("~/3DayLifetime/outplots_qcd7.root", "READ");
TFile *fileQCD_8 = TFile::Open("~/3DayLifetime/outplots_qcd8.root", "READ");
TFile *fileQCD_9 = TFile::Open("~/3DayLifetime/outplots_qcd9.root", "READ");
...
TFile *fileQCDBG_1 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaFiles/outplots_QCDBG1.root", "READ");
TFile *fileQCDB_2 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaFiles/outplots_QCDB_1500to2000.root", "READ");

TFile *fileTT = TFile::Open("~/3DayLifetime/outplots_ttbar.root", "READ");
TFile *fileWj = TFile::Open("~/3DayLifetime/outplots_wjets.root", "READ");
TFile *fileZj = TFile::Open("~/3DayLifetime/outplots_zjets.root", "READ");

TFile *fileWW = TFile::Open("~/3DayLifetime/outplots_WW.root", "READ");
TFile *fileWZ = TFile::Open("~/3DayLifetime/outplots_WZ.root", "READ");
TFile *fileZZ = TFile::Open("~/3DayLifetime/outplots_ZZ.root", "READ");

TFile *fileTTW = TFile::Open("~/3DayLifetime/outplots_ttW.root", "READ");
TFile *fileTTZ = TFile::Open("~/3DayLifetime/outplots_ttZ.root", "READ");
TFile *fileTTTT = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaFiles/outplots_4top.root", "READ");

TFile *fileHbb = TFile::Open("~/3DayLifetime/outplots_Hbb.root", "READ");
TFile *fileHWW = TFile::Open("~/3DayLifetime/outplots_HWW.root", "READ");
...
TTree *treeQCDB_0 = (TTree *) fileQCDB_0->Get("jetVars");
TTree *treeQCDB_1 = (TTree *) fileQCDB_1->Get("jetVars");
TTree *treeQCDBG_1 = (TTree *) fileQCDBG_1->Get("jetVars");
TTree *treeQCDB_2 = (TTree *) fileQCDB_2->Get("jetVars");

TChain *treeDATA = new TChain("jetVars");
...
treeDATA->Add("~/3DayLifetime/outplots_data_H.root");
treeDATA->Add("~/3DayLifetime/outplots_data_G.root");
...
TTree *treeWW = (TTree *) fileWW->Get("jetVars");
TTree *treeWZ = (TTree *) fileWZ->Get("jetVars");
TTree *treeZZ = (TTree *) fileZZ->Get("jetVars");

TTree *treeTTW = (TTree *) fileTTW->Get("jetVars");
TTree *treeTTZ = (TTree *) fileTTZ->Get("jetVars");
TTree *treeTTTT = (TTree *) fileTTTT->Get("jetVars");
TTree *treeHbb = (TTree *) fileHbb->Get("jetVars");
TTree *treeHWW = (TTree *) fileHWW->Get("jetVars");
TTree *treeWplusH = (TTree *) fileWplusH->Get("jetVars");
TTree *treeWminusH = (TTree *) fileWminusH->Get("jetVars");
...
TH1D *histQCDBG_1 = new TH1D("histQCDBG_1", "histQCDBG_1", nbins, xmin, xmax);
...
treeQCDBG_1->Draw( Form( "%s >> histQCDBG_1", var.c_str() ), sel.c_str() );
...
//tree_sig1->Draw( Form( "%s >> hist_sig1", var.c_str() ), Form("decayMode1 <= 3 && decayMode2 <= 3 && %s", sel.c_str()) );
//tree_sig2->Draw( Form( "%s >> hist_sig2", var.c_str() ), Form("decayMode1 <= 3 && decayMode2 <= 3 && %s", sel.c_str()) );
//tree_sig3->Draw( Form( "%s >> hist_sig3", var.c_str() ), Form("decayMode1 <= 3 && decayMode2 <= 3 && %s", sel.c_str()) );
//tree_sig4->Draw( Form( "%s >> hist_sig4", var.c_str() ), Form("decayMode1 <= 3 && decayMode2 <= 3 && %s", sel.c_str()) );


float lumi = 16000.;//35289.97;//8529.407;
...
histQCDB_0->Scale( 320.0 * lumi / (879057.*0.092) ); 
histQCDB_1->Scale( 50.26 * lumi / (221429.*0.082) ); 
histQCDBG_1->Scale( 184.4 * lumi / (834688.) ); 
histQCDB_2->Scale( 4.41 * lumi / (51779.*0.082) ); 

histTT->Scale( 831.76 * lumi / 92925926. );
histWj->Scale( 95.14*.066*lumi / 1025005.);
histZj->Scale( 5.67 * lumi / 1000000.); 

histWW->Scale( 63.21 * lumi / 993214.);
histZZ->Scale( 16.523 * lumi / 910688. );
histWZ->Scale( 47.13  * lumi / 1000000. );
...
int color4 = kGreen - 7;//TColor::GetColorPalette(3*254/nColors);
...
histHbb->SetFillColor(color7+1);
histHbb->SetLineColor(color7+1);
histWplusH->SetFillColor(color7+2);
histWplusH->SetLineColor(color7+2);
...
histQCDB_0->SetLineColor(color1+1);
histQCDB_0->SetFillColor(color1+1);
histQCDB_1->SetLineColor(color1+5);
histQCDB_1->SetFillColor(color1+5);
histQCDBG_1->SetLineColor(kAzure);
histQCDBG_1->SetFillColor(kAzure);
histQCDB_2->SetLineColor(color1+8);
histQCDB_2->SetFillColor(color1+8);

float totQCD = histQCD_1->Integral() + histQCD_2->Integral() + histQCD_3->Integral() + histQCD_4->Integral() + histQCD_5->Integral() + histQCD_6->Integral() + histQCD_7->Integral() + histQCD_8->Integral() + histQCD_9->Integral() + histQCDB_0->Integral() + histQCDB_1->Integral() + histQCDB_2->Integral();
float totDATA = histDATA->Integral();// - histTT->Integral() - histWj->Integral() - histZj->Integral() - histWW->Integral() - histZZ->Integral() - histWZ->Integral() - histTTW->Integral() - histTTZ->Integral() - histTTTT->Integral();
...
histQCDB_0->Scale(totDATA / totQCD);
histQCDB_1->Scale(totDATA / totQCD);
histQCDB_2->Scale(totDATA / totQCD);
...
TLegend *leg = new TLegend(0.55,0.7,0.92,0.86,"");
leg->SetNColumns(2);
leg->SetFillColor(0);
leg->SetLineColor(0);
...
leg->AddEntry(histTT     , "Others" ,"f");
leg->AddEntry(histWj    , "W+jets","f");
leg->AddEntry(histZj      , "Z+jets","f");
leg->AddEntry(histHbb      , "H#rightarrowbb","f");
