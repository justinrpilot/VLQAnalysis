...
void makeThetaTemplates_jerUp_3j(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333){
...
TFile *fileWj = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_wjets_jerUp.root", "READ");
TFile *fileZj = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_zjets_jerUp.root", "READ");

TFile *fileWW = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_WW_jerUp.root", "READ");
TFile *fileWZ = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_WZ_jerUp.root", "READ");
TFile *fileZZ = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_ZZ_jerUp.root", "READ");

TFile *fileTTW = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_ttW_jerUp.root", "READ");
TFile *fileTTZ = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_ttZ_jerUp.root", "READ");
TFile *fileTTTT = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_tttt_jerUp.root", "READ");
...
TFile *sig700 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq700_jerUp.root", "READ");
TFile *sig800 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq800_jerUp.root", "READ");
TFile *sig900 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq900_jerUp.root", "READ");
TFile *sig1000 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1000_jerUp.root", "READ");
TFile *sig1100 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1100_jerUp.root", "READ");
TFile *sig1200 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1200_jerUp.root", "READ");
TFile *sig1300 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1300_jerUp.root", "READ");
TFile *sig1400 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1400_jerUp.root", "READ");
TFile *sig1500 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1500_jerUp.root", "READ");
TFile *sig1600 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1600_jerUp.root", "READ");
TFile *sig1700 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1700_jerUp.root", "READ");
TFile *sig1800 = TFile::Open("root://cmseos.fnal.gov//store/user/pilot/VLQAnaMay/outplots_vlq1800_jerUp.root", "READ");
...
cout << "HERE " << endl;
TFile *outFile = new TFile(TString::Format("%s_histos_jerUp.root", channel.c_str()), "RECREATE");
...
histTT->Write(TString::Format("%s__ttbar__jer__plus", channel.c_str()));
histWj->Write(TString::Format("%s__wjets__jer__plus", channel.c_str()));
histZj->Write(TString::Format("%s__zjets__jer__plus", channel.c_str()));
histWW->Write(TString::Format("%s__diboson__jer__plus", channel.c_str()));
histTTW->Write(TString::Format("%s__ttV__jer__plus", channel.c_str()));

hist_sig700->Write(TString::Format("%s__tprime700__jer__plus", channel.c_str()));
hist_sig800->Write(TString::Format("%s__tprime800__jer__plus", channel.c_str()));
hist_sig900->Write(TString::Format("%s__tprime900__jer__plus", channel.c_str()));
hist_sig1000->Write(TString::Format("%s__tprime1000__jer__plus", channel.c_str()));
hist_sig1100->Write(TString::Format("%s__tprime1100__jer__plus", channel.c_str()));
hist_sig1200->Write(TString::Format("%s__tprime1200__jer__plus", channel.c_str()));
hist_sig1300->Write(TString::Format("%s__tprime1300__jer__plus", channel.c_str()));
hist_sig1400->Write(TString::Format("%s__tprime1400__jer__plus", channel.c_str()));
hist_sig1500->Write(TString::Format("%s__tprime1500__jer__plus", channel.c_str()));
hist_sig1600->Write(TString::Format("%s__tprime1600__jer__plus", channel.c_str()));
hist_sig1700->Write(TString::Format("%s__tprime1700__jer__plus", channel.c_str()));
hist_sig1800->Write(TString::Format("%s__tprime1800__jer__plus", channel.c_str()));
