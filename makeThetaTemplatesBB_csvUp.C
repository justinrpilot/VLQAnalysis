...
void makeThetaTemplatesBB_csvUp(int numTop, int numW, int numZ, int numH, int numB, float br_bw = 0.3333333, float br_tz = 0.3333333, float br_th = 0.333333){
...
string var = "ht";
TString selT = Form("csvEventWt*(numJets == 4 && jetPt_j3 > 400. && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", numTop, numW, numZ, numH, numB);
...
TString sigselT = Form("csvEventWt*(((decayMode1 == 1 && decayMode2 == 1) || (decayMode2 == 1 && decayMode1 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 2) || (decayMode1 == 2 && decayMode2 == 1))*%f + ((decayMode1 == 1 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 1))*%f + ((decayMode1 == 2 && decayMode2 == 3) || (decayMode1 == 3 && decayMode2 == 2))*%f +((decayMode1 == 2 && decayMode2 == 2) || (decayMode2 == 2 && decayMode1 == 2))*%f + ((decayMode1 == 3 && decayMode2 == 3) || (decayMode2 == 3 && decayMode1 == 3))*%f  ) * (numJets == 4 && jetPt_j3 > 400. && numTop == %d && numW == %d && numZ == %d && numH == %d && numB == %d)", 3*br_tz*3*br_tz, 3*br_tz*3*br_bw, 3*br_tz*3*br_th, 3*br_bw*3*br_th, 3*br_bw*3*br_bw, 3*br_th*3*br_th, numTop, numW, numZ, numH, numB);
...
cout << "HERE " << endl;
TFile *outFile = new TFile(TString::Format("%s_histos_csvUp.root", channel.c_str()), "RECREATE");
...
histTT->Write(TString::Format("%s__ttbar__csv__plus", channel.c_str()));
histWj->Write(TString::Format("%s__wjets__csv__plus", channel.c_str()));
histZj->Write(TString::Format("%s__zjets__csv__plus", channel.c_str()));
histWW->Write(TString::Format("%s__diboson__csv__plus", channel.c_str()));
histTTW->Write(TString::Format("%s__ttV__csv__plus", channel.c_str()));
histHbb->Write(TString::Format("%s__higgs__csv__plus", channel.c_str()));


hist_sig700->Write(TString::Format("%s__tprime700__csv__plus", channel.c_str()));
hist_sig800->Write(TString::Format("%s__tprime800__csv__plus", channel.c_str()));
hist_sig900->Write(TString::Format("%s__tprime900__csv__plus", channel.c_str()));
hist_sig1000->Write(TString::Format("%s__tprime1000__csv__plus", channel.c_str()));
hist_sig1100->Write(TString::Format("%s__tprime1100__csv__plus", channel.c_str()));
hist_sig1200->Write(TString::Format("%s__tprime1200__csv__plus", channel.c_str()));
hist_sig1300->Write(TString::Format("%s__tprime1300__csv__plus", channel.c_str()));
hist_sig1400->Write(TString::Format("%s__tprime1400__csv__plus", channel.c_str()));
hist_sig1500->Write(TString::Format("%s__tprime1500__csv__plus", channel.c_str()));
hist_sig1600->Write(TString::Format("%s__tprime1600__csv__plus", channel.c_str()));
hist_sig1700->Write(TString::Format("%s__tprime1700__csv__plus", channel.c_str()));
hist_sig1800->Write(TString::Format("%s__tprime1800__csv__plus", channel.c_str()));
